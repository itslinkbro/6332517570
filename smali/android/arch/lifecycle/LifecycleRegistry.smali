...
.method private c()V
    ...
    invoke-virtual {v1}, Landroid/arch/core/internal/FastSafeIterableMap;->a()I
    ...
    invoke-virtual {v4}, Landroid/arch/core/internal/FastSafeIterableMap;->e()Ljava/util/Map$Entry;
    ...
    iget-object v4, v4, Landroid/arch/lifecycle/LifecycleRegistry$ObserverWithState;->a:Landroid/arch/lifecycle/Lifecycle$State;
    ...
    .line 1300
    invoke-virtual {v1}, Landroid/arch/core/internal/FastSafeIterableMap;->b()Ljava/util/Iterator;
    ...
    iget-object v5, p0, Landroid/arch/lifecycle/LifecycleRegistry;->b:Landroid/arch/lifecycle/Lifecycle$State;
    ...
    iget-boolean v4, p0, Landroid/arch/lifecycle/LifecycleRegistry;->f:Z
    ...
    invoke-virtual {v4, v5}, Landroid/arch/core/internal/FastSafeIterableMap;->c(Ljava/lang/Object;)Z
    ...
    .line 1307
    :goto_3
    invoke-static {v4}, Landroid/arch/lifecycle/LifecycleRegistry;->b(Landroid/arch/lifecycle/Lifecycle$Event;)Landroid/arch/lifecycle/Lifecycle$State;

    move-result-object v5

    invoke-direct {p0, v5}, Landroid/arch/lifecycle/LifecycleRegistry;->c(Landroid/arch/lifecycle/Lifecycle$State;)V

    .line 1308
    invoke-virtual {v3, v0, v4}, Landroid/arch/lifecycle/LifecycleRegistry$ObserverWithState;->a(Landroid/arch/lifecycle/LifecycleOwner;Landroid/arch/lifecycle/Lifecycle$Event;)V
...
.method public final a(Landroid/arch/lifecycle/LifecycleObserver;)V
    .locals 6
...
.method public final b(Landroid/arch/lifecycle/LifecycleObserver;)V
    .locals 1
