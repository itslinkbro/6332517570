...
.method private a(Landroid/widget/TextView;Landroid/widget/ImageView;)V
    ...
    .line 1730
    :goto_1
    iget-object v3, p0, Landroid/support/design/widget/TabLayout$TabView;->b:Landroid/support/design/widget/TabLayout$Tab;

    if-eqz v3, :cond_2

    iget-object v3, p0, Landroid/support/design/widget/TabLayout$TabView;->b:Landroid/support/design/widget/TabLayout$Tab;

    invoke-virtual {v3}, Landroid/support/design/widget/TabLayout$Tab;->g()Ljava/lang/CharSequence;
...
.method final a()V
    ...
    .line 1662
    invoke-virtual {v0}, Landroid/support/design/widget/TabLayout$Tab;->a()Landroid/view/View;
    ...
    .line 1672
    iget-object v3, p0, Landroid/support/design/widget/TabLayout$TabView;->c:Landroid/widget/TextView;
    ...
    .line 1675
    :cond_3
    iget-object v3, p0, Landroid/support/design/widget/TabLayout$TabView;->d:Landroid/widget/ImageView;
    ...
    iput-object v1, p0, Landroid/support/design/widget/TabLayout$TabView;->f:Landroid/widget/TextView;

    .line 1681
    iget-object v1, p0, Landroid/support/design/widget/TabLayout$TabView;->f:Landroid/widget/TextView;
    ...
    iput v1, p0, Landroid/support/design/widget/TabLayout$TabView;->h:I
    ...
    iput-object v1, p0, Landroid/support/design/widget/TabLayout$TabView;->g:Landroid/widget/ImageView;

    goto :goto_1

    .line 1687
    :cond_6
    iget-object v2, p0, Landroid/support/design/widget/TabLayout$TabView;->e:Landroid/view/View;
    ...
    .line 1689
    iput-object v1, p0, Landroid/support/design/widget/TabLayout$TabView;->e:Landroid/view/View;
    ...
    .line 1695
    :goto_1
    iget-object v1, p0, Landroid/support/design/widget/TabLayout$TabView;->e:Landroid/view/View;
    ...
    .line 1697
    iget-object v1, p0, Landroid/support/design/widget/TabLayout$TabView;->d:Landroid/widget/ImageView;
    ...
    .line 1701
    iput-object v1, p0, Landroid/support/design/widget/TabLayout$TabView;->d:Landroid/widget/ImageView;
    ...
    .line 1707
    iput-object v1, p0, Landroid/support/design/widget/TabLayout$TabView;->c:Landroid/widget/TextView;
    ...
    iget-object v3, p0, Landroid/support/design/widget/TabLayout$TabView;->a:Landroid/support/design/widget/TabLayout;
    ...
    .line 1711
    iget-object v1, p0, Landroid/support/design/widget/TabLayout$TabView;->a:Landroid/support/design/widget/TabLayout;
    ...
    invoke-direct {p0, v1, v3}, Landroid/support/design/widget/TabLayout$TabView;->a(Landroid/widget/TextView;Landroid/widget/ImageView;)V
    ...
    iget-object v1, p0, Landroid/support/design/widget/TabLayout$TabView;->g:Landroid/widget/ImageView;
    ...
    iget-object v3, p0, Landroid/support/design/widget/TabLayout$TabView;->g:Landroid/widget/ImageView;
    ...
    .line 1723
    invoke-virtual {v0}, Landroid/support/design/widget/TabLayout$Tab;->f()Z
...
.method final a(Landroid/support/design/widget/TabLayout$Tab;)V
    ...
    .line 1651
    invoke-virtual {p0}, Landroid/support/design/widget/TabLayout$TabView;->a()V
...
.method public onMeasure(II)V
    ...
    .line 1595
    :cond_0
    iget-object p1, p0, Landroid/support/design/widget/TabLayout$TabView;->a:Landroid/support/design/widget/TabLayout;
    ...
    .line 1608
    iget v1, p0, Landroid/support/design/widget/TabLayout$TabView;->h:I
    ...
    .line 1613
    :cond_2
    iget-object v2, p0, Landroid/support/design/widget/TabLayout$TabView;->c:Landroid/widget/TextView;
    ...
    .line 1626
    :cond_4
    iget-object v5, p0, Landroid/support/design/widget/TabLayout$TabView;->a:Landroid/support/design/widget/TabLayout;
