...
.method private constructor <init>(II[B)V
    ...
    .line 2937
    iput p1, p0, Landroid/support/media/ExifInterface$ExifAttribute;->a:I

    .line 2938
    iput p2, p0, Landroid/support/media/ExifInterface$ExifAttribute;->b:I

    .line 2939
    iput-object p3, p0, Landroid/support/media/ExifInterface$ExifAttribute;->c:[B
...
.method public static a(ILjava/nio/ByteOrder;)Landroid/support/media/ExifInterface$ExifAttribute;
    .locals 5
    ...
    .line 3943
    sget-object p0, Landroid/support/media/ExifInterface;->f:[I
...
.method public static a(JLjava/nio/ByteOrder;)Landroid/support/media/ExifInterface$ExifAttribute;
    .locals 5
...
.method public static a(Landroid/support/media/ExifInterface$Rational;Ljava/nio/ByteOrder;)Landroid/support/media/ExifInterface$ExifAttribute;
    .locals 7
    ...
    .line 4004
    iget-wide v5, v4, Landroid/support/media/ExifInterface$Rational;->a:J
...
.method public static a(Ljava/lang/String;)Landroid/support/media/ExifInterface$ExifAttribute;
    .locals 3
    ...
    invoke-static {}, Landroid/support/media/ExifInterface;->a()Ljava/nio/charset/Charset;
...
.method static synthetic a(Landroid/support/media/ExifInterface$ExifAttribute;Ljava/nio/ByteOrder;)Ljava/lang/Object;
    .locals 0

    .line 2931
    invoke-direct {p0, p1}, Landroid/support/media/ExifInterface$ExifAttribute;->d(Ljava/nio/ByteOrder;)Ljava/lang/Object;
...
.method private d(Ljava/nio/ByteOrder;)Ljava/lang/Object;
    ...
    iget-object v2, p0, Landroid/support/media/ExifInterface$ExifAttribute;->c:[B
    ...
    .line 3052
    :try_start_1
    invoke-virtual {v1, p1}, Landroid/support/media/ExifInterface$ByteOrderedDataInputStream;->a(Ljava/nio/ByteOrder;)V

    .line 3053
    iget p1, p0, Landroid/support/media/ExifInterface$ExifAttribute;->a:I
    :try_end_1
    ...
    :pswitch_0
    :try_start_3
    iget p1, p0, Landroid/support/media/ExifInterface$ExifAttribute;->b:I

    new-array p1, p1, [D

    .line 3148
    :goto_0
    iget v2, p0, Landroid/support/media/ExifInterface$ExifAttribute;->b:I
    ...
    invoke-direct/range {v4 .. v9}, Landroid/support/media/ExifInterface$Rational;-><init>(JJB)V
    ...
    .line 3110
    invoke-virtual {v1}, Landroid/support/media/ExifInterface$ByteOrderedDataInputStream;->b()J
    ...
    invoke-static {}, Landroid/support/media/ExifInterface;->b()[B
    ...
    .line 3068
    iget-object v4, p0, Landroid/support/media/ExifInterface$ExifAttribute;->c:[B
    ...
    :pswitch_9
    :try_start_15
    iget-object p1, p0, Landroid/support/media/ExifInterface$ExifAttribute;->c:[B
...
.method public final a(Ljava/nio/ByteOrder;)D
    ...
    .line 4926
    iget-wide v0, p1, Landroid/support/media/ExifInterface$Rational;->a:J

    long-to-double v0, v0

    iget-wide v2, p1, Landroid/support/media/ExifInterface$Rational;->b:J
...
.method public final c(Ljava/nio/ByteOrder;)Ljava/lang/String;
    ...
    iget-wide v4, v0, Landroid/support/media/ExifInterface$Rational;->a:J
    ...
    iget-wide v4, v0, Landroid/support/media/ExifInterface$Rational;->b:J
...
.method public toString()Ljava/lang/String;
    ...
    sget-object v1, Landroid/support/media/ExifInterface;->e:[Ljava/lang/String;

    iget v2, p0, Landroid/support/media/ExifInterface$ExifAttribute;->a:I
    ...
    iget-object v1, p0, Landroid/support/media/ExifInterface$ExifAttribute;->c:[B
