...
.method public a(Landroid/support/v7/view/menu/MenuItemImpl;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 1166
    :cond_0
    iget-object p2, p0, Landroid/support/v7/view/menu/BaseMenuPresenter;->d:Landroid/view/LayoutInflater;

    iget v0, p0, Landroid/support/v7/view/menu/BaseMenuPresenter;->i:I
...
.method public a(Z)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/view/menu/MenuBuilder;->l()V
    ...
    .line 100
    invoke-virtual {p0, v5}, Landroid/support/v7/view/menu/BaseMenuPresenter;->c(Landroid/support/v7/view/menu/MenuItemImpl;)Z
    ...
    .line 103
    invoke-interface {v7}, Landroid/support/v7/view/menu/MenuView$ItemView;->a()Landroid/support/v7/view/menu/MenuItemImpl;
    ...
    .line 1137
    :cond_3
    iget-object v5, p0, Landroid/support/v7/view/menu/BaseMenuPresenter;->f:Landroid/support/v7/view/menu/MenuView;
