...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/view/menu/MenuBuilder;Landroid/view/View;IIZ)V
    ...
    invoke-direct {p3, p4, p5, p6}, Landroid/support/v7/widget/MenuPopupWindow;-><init>(Landroid/content/Context;II)V
...
.method public final a(Landroid/support/v7/view/menu/SubMenuBuilder;)Z
    ...
    .line 261
    iget-object v2, p0, Landroid/support/v7/view/menu/StandardMenuPopup;->n:Landroid/support/v7/view/menu/MenuPresenter$Callback;

    invoke-virtual {v0, v2}, Landroid/support/v7/view/menu/MenuPopupHelper;->a(Landroid/support/v7/view/menu/MenuPresenter$Callback;)V
    ...
    invoke-virtual {v2}, Landroid/support/v7/widget/MenuPopupWindow;->l()I
    ...
    invoke-virtual {v3}, Landroid/support/v7/widget/MenuPopupWindow;->m()I
...
.method public final b()V
    ...
    invoke-virtual {v0, v3}, Landroid/support/v7/widget/MenuPopupWindow;->c(I)V
    ...
    invoke-virtual {v0, v4}, Landroid/support/v7/widget/MenuPopupWindow;->d(I)V

    .line 2174
    iget-object v0, p0, Landroid/support/v7/view/menu/StandardMenuPopup;->a:Landroid/support/v7/widget/MenuPopupWindow;

    invoke-virtual {v0}, Landroid/support/v7/widget/MenuPopupWindow;->o()V
    ...
    .line 2300
    iget-object v4, v4, Landroid/support/v7/view/menu/MenuBuilder;->a:Ljava/lang/CharSequence;
    ...
    .line 3300
    iget-object v6, v6, Landroid/support/v7/view/menu/MenuBuilder;->a:Ljava/lang/CharSequence;
