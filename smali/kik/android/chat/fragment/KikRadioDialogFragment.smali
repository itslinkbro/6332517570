...
.field private h:Lkik/android/chat/vm/br;

.field private i:Lkik/android/e/ak;
...
.method static synthetic a(Lkik/android/chat/fragment/KikRadioDialogFragment;Lkik/android/chat/vm/ax;Landroid/content/DialogInterface;I)V
    .locals 0
    ...
    .line 61
    invoke-interface {p1}, Lkik/android/chat/vm/ax;->j()V
...
.method public onCreateDialog(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    .line 35
    iget-object v0, p0, Lkik/android/chat/fragment/KikRadioDialogFragment;->h:Lkik/android/chat/vm/br;
    ...
    invoke-direct {v0, v1}, Lkik/android/chat/vm/cv;-><init>(Landroid/app/Activity;)V

    iput-object v0, p0, Lkik/android/chat/fragment/KikRadioDialogFragment;->h:Lkik/android/chat/vm/br;
    ...
    iget-object v2, p0, Lkik/android/chat/fragment/KikRadioDialogFragment;->h:Lkik/android/chat/vm/br;

    invoke-virtual {v1, v0, v2}, Lkik/android/chat/vm/DialogViewModel;->a(Lcom/kik/components/CoreComponent;Lkik/android/chat/vm/br;)V
    ...
    invoke-direct {v1, v2}, Lkik/android/chat/vm/s;-><init>(Ljava/util/List;)V

    .line 44
    iget-object v2, p0, Lkik/android/chat/fragment/KikRadioDialogFragment;->h:Lkik/android/chat/vm/br;

    invoke-interface {v1, v0, v2}, Lkik/android/chat/vm/ax;->a(Lcom/kik/components/CoreComponent;Lkik/android/chat/vm/br;)V
    ...
    iput-object v0, p0, Lkik/android/chat/fragment/KikRadioDialogFragment;->i:Lkik/android/e/ak;

    .line 48
    iget-object v0, p0, Lkik/android/chat/fragment/KikRadioDialogFragment;->i:Lkik/android/e/ak;

    invoke-virtual {v0, v1}, Lkik/android/e/ak;->a(Lkik/android/chat/vm/ax;)V

    .line 49
    iget-object v0, p0, Lkik/android/chat/fragment/KikRadioDialogFragment;->i:Lkik/android/e/ak;

    invoke-virtual {v0}, Lkik/android/e/ak;->getRoot()Landroid/view/View;
    ...
    invoke-static {p0, v1}, Lkik/android/chat/fragment/fn;->a(Lkik/android/chat/fragment/KikRadioDialogFragment;Lkik/android/chat/vm/ax;)Landroid/content/DialogInterface$OnClickListener;
    ...
    invoke-virtual {v1}, Lkik/android/chat/vm/DialogViewModel;->C_()Ljava/lang/String;
