...
.field private g:Lkik/android/e/bg;

.field private h:Lkik/android/chat/vm/bz;
...
.method static synthetic a(Lkik/android/chat/fragment/KikGranReportDialogFragment;Lkik/android/chat/vm/br;)Lkik/android/chat/vm/br;
    .locals 0

    .line 23
    iput-object p1, p0, Lkik/android/chat/fragment/KikGranReportDialogFragment;->i:Lkik/android/chat/vm/br;

    return-object p1
.end method

.method static synthetic a(Lkik/android/chat/fragment/KikGranReportDialogFragment;Lkik/android/chat/vm/bz;)Lkik/android/chat/vm/bz;
    .locals 0

    .line 23
    iput-object p1, p0, Lkik/android/chat/fragment/KikGranReportDialogFragment;->h:Lkik/android/chat/vm/bz;
...
.method static synthetic a(Lkik/android/chat/fragment/KikGranReportDialogFragment;)V
    ...
    .line 55
    iget-object p0, p0, Lkik/android/chat/fragment/KikGranReportDialogFragment;->h:Lkik/android/chat/vm/bz;

    invoke-interface {p0}, Lkik/android/chat/vm/bz;->O_()V
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .line 1079
    iget-object p1, p0, Lkik/android/chat/fragment/KikGranReportDialogFragment;->g:Lkik/android/e/bg;
...
.method public onCreateDialog(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    .line 36
    iget-object v0, p0, Lkik/android/chat/fragment/KikGranReportDialogFragment;->i:Lkik/android/chat/vm/br;
    ...
    .line 39
    :cond_0
    iget-object v0, p0, Lkik/android/chat/fragment/KikGranReportDialogFragment;->h:Lkik/android/chat/vm/bz;

    invoke-virtual {p0}, Lkik/android/chat/fragment/KikGranReportDialogFragment;->getActivity()Landroid/support/v4/app/FragmentActivity;

    move-result-object v1

    invoke-static {v1}, Lkik/android/util/y;->a(Landroid/content/Context;)Lcom/kik/components/CoreComponent;

    move-result-object v1

    iget-object v2, p0, Lkik/android/chat/fragment/KikGranReportDialogFragment;->i:Lkik/android/chat/vm/br;

    invoke-interface {v0, v1, v2}, Lkik/android/chat/vm/bz;->a(Lcom/kik/components/CoreComponent;Lkik/android/chat/vm/br;)V
    ...
    iput-object v0, p0, Lkik/android/chat/fragment/KikGranReportDialogFragment;->g:Lkik/android/e/bg;

    .line 42
    iget-object v0, p0, Lkik/android/chat/fragment/KikGranReportDialogFragment;->g:Lkik/android/e/bg;

    iget-object v1, p0, Lkik/android/chat/fragment/KikGranReportDialogFragment;->h:Lkik/android/chat/vm/bz;

    invoke-virtual {v0, v1}, Lkik/android/e/bg;->a(Lkik/android/chat/vm/bz;)V

    .line 43
    iget-object v0, p0, Lkik/android/chat/fragment/KikGranReportDialogFragment;->g:Lkik/android/e/bg;

    iget-object v0, v0, Lkik/android/e/bg;->b:Lkik/android/e/ai;

    iget-object v1, p0, Lkik/android/chat/fragment/KikGranReportDialogFragment;->h:Lkik/android/chat/vm/bz;

    invoke-virtual {v0, v1}, Lkik/android/e/ai;->a(Lkik/android/chat/vm/bz;)V

    .line 44
    iget-object v0, p0, Lkik/android/chat/fragment/KikGranReportDialogFragment;->g:Lkik/android/e/bg;

    iget-object v0, v0, Lkik/android/e/bg;->c:Lkik/android/e/ah;

    iget-object v1, p0, Lkik/android/chat/fragment/KikGranReportDialogFragment;->h:Lkik/android/chat/vm/bz;

    invoke-virtual {v0, v1}, Lkik/android/e/ah;->a(Lkik/android/chat/vm/bz;)V
    ...
    invoke-interface {v1}, Lkik/android/chat/vm/bz;->i()Ljava/lang/String;

    move-result-object v1

    invoke-static {p0}, Lkik/android/chat/fragment/do;->a(Lkik/android/chat/fragment/KikGranReportDialogFragment;)Landroid/content/DialogInterface$OnClickListener;
    ...
    invoke-interface {v1}, Lkik/android/chat/vm/bz;->C_()Ljava/lang/String;
