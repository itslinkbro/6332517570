...
.method private constructor <init>(Landroid/support/v4/util/Pools$Pool;Lcom/bumptech/glide/load/model/q$c;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private declared-synchronized b(Ljava/lang/Class;Ljava/lang/Class;)Ljava/util/List;
    ...
    .line 83
    invoke-virtual {v2, p1, p2}, Lcom/bumptech/glide/load/model/q$b;->a(Ljava/lang/Class;Ljava/lang/Class;)Z
    ...
    .line 1173
    iget-object v2, v2, Lcom/bumptech/glide/load/model/q$b;->b:Lcom/bumptech/glide/load/model/n;
...
# virtual methods
.method public final declared-synchronized a(Ljava/lang/Class;Ljava/lang/Class;)Lcom/bumptech/glide/load/model/m;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<Model:",
    ...
    .line 151
    iget-object p1, p0, Lcom/bumptech/glide/load/model/q;->f:Landroid/support/v4/util/Pools$Pool;

    .line 1216
    new-instance p2, Lcom/bumptech/glide/load/model/p;

    invoke-direct {p2, v0, p1}, Lcom/bumptech/glide/load/model/p;-><init>(Ljava/util/List;Landroid/support/v4/util/Pools$Pool;)V
    :try_end_0
    ...
    .line 2185
    :try_start_2
    sget-object p1, Lcom/bumptech/glide/load/model/q;->b:Lcom/bumptech/glide/load/model/m;
    :try_end_2
...
.method final declared-synchronized a(Ljava/lang/Class;Ljava/lang/Class;Lcom/bumptech/glide/load/model/n;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<Model:",
    ...
    iget-object p2, p0, Lcom/bumptech/glide/load/model/q;->c:Ljava/util/List;
...
.method final declared-synchronized b(Ljava/lang/Class;Ljava/lang/Class;Lcom/bumptech/glide/load/model/n;)Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<Model:",
    ...
    .line 71
    :try_start_0
    invoke-direct {p0, p1, p2}, Lcom/bumptech/glide/load/model/q;->b(Ljava/lang/Class;Ljava/lang/Class;)Ljava/util/List;

    move-result-object v0

    .line 72
    invoke-virtual {p0, p1, p2, p3}, Lcom/bumptech/glide/load/model/q;->a(Ljava/lang/Class;Ljava/lang/Class;Lcom/bumptech/glide/load/model/n;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
