...
.method public init(ZLorg/bouncycastle/crypto/CipherParameters;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/engines/RSABlindedEngine;->c:Lorg/bouncycastle/crypto/params/RSAKeyParameters;
    ...
    :goto_0
    iput-object p1, p0, Lorg/bouncycastle/crypto/engines/RSABlindedEngine;->d:Ljava/security/SecureRandom;
...
.method public processBlock([BII)[B
    ...
    iget-object p2, p0, Lorg/bouncycastle/crypto/engines/RSABlindedEngine;->c:Lorg/bouncycastle/crypto/params/RSAKeyParameters;
    ...
    sget-object v0, Lorg/bouncycastle/crypto/engines/RSABlindedEngine;->a:Ljava/math/BigInteger;

    sget-object v1, Lorg/bouncycastle/crypto/engines/RSABlindedEngine;->a:Ljava/math/BigInteger;

    invoke-virtual {p2, v1}, Ljava/math/BigInteger;->subtract(Ljava/math/BigInteger;)Ljava/math/BigInteger;

    move-result-object v1

    iget-object v2, p0, Lorg/bouncycastle/crypto/engines/RSABlindedEngine;->d:Ljava/security/SecureRandom;

    invoke-static {v0, v1, v2}, Lorg/bouncycastle/util/BigIntegers;->a(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/security/SecureRandom;)Ljava/math/BigInteger;
    ...
    iget-object p3, p0, Lorg/bouncycastle/crypto/engines/RSABlindedEngine;->b:Lorg/bouncycastle/crypto/engines/a;

    invoke-virtual {p3, p1}, Lorg/bouncycastle/crypto/engines/a;->processBlock(Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    :cond_1
    iget-object p2, p0, Lorg/bouncycastle/crypto/engines/RSABlindedEngine;->b:Lorg/bouncycastle/crypto/engines/a;

    invoke-virtual {p2, p1}, Lorg/bouncycastle/crypto/engines/a;->processBlock(Ljava/math/BigInteger;)Ljava/math/BigInteger;
