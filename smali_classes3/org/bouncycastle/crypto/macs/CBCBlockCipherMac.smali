...
.method public constructor <init>(Lorg/bouncycastle/crypto/BlockCipher;ILorg/bouncycastle/crypto/paddings/BlockCipherPadding;)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/crypto/macs/CBCBlockCipherMac;->d:Lorg/bouncycastle/crypto/BlockCipher;
...
.method public doFinal([BI)I
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/macs/CBCBlockCipherMac;->d:Lorg/bouncycastle/crypto/BlockCipher;

    invoke-interface {v0}, Lorg/bouncycastle/crypto/BlockCipher;->getBlockSize()I

    move-result v0

    iget-object v1, p0, Lorg/bouncycastle/crypto/macs/CBCBlockCipherMac;->e:Lorg/bouncycastle/crypto/paddings/BlockCipherPadding;
    ...
    :goto_0
    iget v1, p0, Lorg/bouncycastle/crypto/macs/CBCBlockCipherMac;->c:I

    if-ge v1, v0, :cond_2

    iget-object v1, p0, Lorg/bouncycastle/crypto/macs/CBCBlockCipherMac;->b:[B

    iget v3, p0, Lorg/bouncycastle/crypto/macs/CBCBlockCipherMac;->c:I
    ...
    :cond_1
    iget-object v0, p0, Lorg/bouncycastle/crypto/macs/CBCBlockCipherMac;->e:Lorg/bouncycastle/crypto/paddings/BlockCipherPadding;
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/macs/CBCBlockCipherMac;->a:[B

    iget v1, p0, Lorg/bouncycastle/crypto/macs/CBCBlockCipherMac;->f:I

    invoke-static {v0, v2, p1, p2, v1}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    invoke-virtual {p0}, Lorg/bouncycastle/crypto/macs/CBCBlockCipherMac;->reset()V

    iget p1, p0, Lorg/bouncycastle/crypto/macs/CBCBlockCipherMac;->f:I
...
.method public update(B)V
    ...
    iput v3, p0, Lorg/bouncycastle/crypto/macs/CBCBlockCipherMac;->c:I

    :cond_0
    iget-object v0, p0, Lorg/bouncycastle/crypto/macs/CBCBlockCipherMac;->b:[B
...
.method public update([BII)V
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/macs/CBCBlockCipherMac;->d:Lorg/bouncycastle/crypto/BlockCipher;

    iget-object v3, p0, Lorg/bouncycastle/crypto/macs/CBCBlockCipherMac;->b:[B

    iget-object v4, p0, Lorg/bouncycastle/crypto/macs/CBCBlockCipherMac;->a:[B

    const/4 v5, 0x0

    invoke-interface {v2, v3, v5, v4, v5}, Lorg/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I

    iput v5, p0, Lorg/bouncycastle/crypto/macs/CBCBlockCipherMac;->c:I
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/macs/CBCBlockCipherMac;->d:Lorg/bouncycastle/crypto/BlockCipher;
