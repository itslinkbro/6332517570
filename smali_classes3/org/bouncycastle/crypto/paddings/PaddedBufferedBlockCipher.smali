...
.method public constructor <init>(Lorg/bouncycastle/crypto/BlockCipher;Lorg/bouncycastle/crypto/paddings/BlockCipherPadding;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/paddings/PaddedBufferedBlockCipher;->d:Lorg/bouncycastle/crypto/BlockCipher;
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/paddings/PaddedBufferedBlockCipher;->a:[B

    const/4 p1, 0x0

    iput p1, p0, Lorg/bouncycastle/crypto/paddings/PaddedBufferedBlockCipher;->b:I
...
.method public doFinal([BI)I
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/paddings/PaddedBufferedBlockCipher;->d:Lorg/bouncycastle/crypto/BlockCipher;

    invoke-interface {v0}, Lorg/bouncycastle/crypto/BlockCipher;->getBlockSize()I

    move-result v0

    iget-boolean v1, p0, Lorg/bouncycastle/crypto/paddings/PaddedBufferedBlockCipher;->c:Z

    const/4 v2, 0x0

    if-eqz v1, :cond_2

    iget v1, p0, Lorg/bouncycastle/crypto/paddings/PaddedBufferedBlockCipher;->b:I
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/paddings/PaddedBufferedBlockCipher;->a:[B

    invoke-interface {v0, v1, v2, p1, p2}, Lorg/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I

    move-result v0

    iput v2, p0, Lorg/bouncycastle/crypto/paddings/PaddedBufferedBlockCipher;->b:I
    ...
    iget-object v3, p0, Lorg/bouncycastle/crypto/paddings/PaddedBufferedBlockCipher;->a:[B

    iget v4, p0, Lorg/bouncycastle/crypto/paddings/PaddedBufferedBlockCipher;->b:I

    invoke-interface {v1, v3, v4}, Lorg/bouncycastle/crypto/paddings/BlockCipherPadding;->addPadding([BI)I

    iget-object v1, p0, Lorg/bouncycastle/crypto/paddings/PaddedBufferedBlockCipher;->d:Lorg/bouncycastle/crypto/BlockCipher;
...
.method public getOutputSize(I)I
    ...
    iget v0, p0, Lorg/bouncycastle/crypto/paddings/PaddedBufferedBlockCipher;->b:I

    add-int/2addr p1, v0

    iget-object v0, p0, Lorg/bouncycastle/crypto/paddings/PaddedBufferedBlockCipher;->a:[B
    ...
    iget-boolean v0, p0, Lorg/bouncycastle/crypto/paddings/PaddedBufferedBlockCipher;->c:Z
...
.method public init(ZLorg/bouncycastle/crypto/CipherParameters;)V
    ...
    iput-boolean p1, p0, Lorg/bouncycastle/crypto/paddings/PaddedBufferedBlockCipher;->c:Z
...
.method public processByte(B[BI)I
    ...
    :goto_0
    iget-object p3, p0, Lorg/bouncycastle/crypto/paddings/PaddedBufferedBlockCipher;->a:[B

    iget v0, p0, Lorg/bouncycastle/crypto/paddings/PaddedBufferedBlockCipher;->b:I

    add-int/lit8 v1, v0, 0x1

    iput v1, p0, Lorg/bouncycastle/crypto/paddings/PaddedBufferedBlockCipher;->b:I
...
.method public processBytes([BII[BI)I
    ...
    iget v2, p0, Lorg/bouncycastle/crypto/paddings/PaddedBufferedBlockCipher;->b:I
    ...
    iget-object v3, p0, Lorg/bouncycastle/crypto/paddings/PaddedBufferedBlockCipher;->d:Lorg/bouncycastle/crypto/BlockCipher;

    iget-object v4, p0, Lorg/bouncycastle/crypto/paddings/PaddedBufferedBlockCipher;->a:[B
    ...
    :cond_2
    iget-object p4, p0, Lorg/bouncycastle/crypto/paddings/PaddedBufferedBlockCipher;->a:[B

    iget p5, p0, Lorg/bouncycastle/crypto/paddings/PaddedBufferedBlockCipher;->b:I

    invoke-static {p1, p2, p4, p5, p3}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    iget p1, p0, Lorg/bouncycastle/crypto/paddings/PaddedBufferedBlockCipher;->b:I
