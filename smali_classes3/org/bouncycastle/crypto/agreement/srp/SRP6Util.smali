...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncycastle/crypto/agreement/srp/SRP6Util;->a:Ljava/math/BigInteger;
    ...
    sput-object v0, Lorg/bouncycastle/crypto/agreement/srp/SRP6Util;->b:Ljava/math/BigInteger;
...
.method public static calculateX(Lorg/bouncycastle/crypto/Digest;Ljava/math/BigInteger;[B[B[B)Ljava/math/BigInteger;
    ...
    invoke-interface {p0, v0, v2, p2}, Lorg/bouncycastle/crypto/Digest;->update([BII)V
    ...
    invoke-direct {p0, p2, v0}, Ljava/math/BigInteger;-><init>(I[B)V
...
.method public static generatePrivateValue(Lorg/bouncycastle/crypto/Digest;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/security/SecureRandom;)Ljava/math/BigInteger;
    ...
    sget-object p2, Lorg/bouncycastle/crypto/agreement/srp/SRP6Util;->b:Ljava/math/BigInteger;
    ...
    invoke-static {p0, p1, p3}, Lorg/bouncycastle/util/BigIntegers;->a(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/security/SecureRandom;)Ljava/math/BigInteger;
...
.method private static getPadded(Ljava/math/BigInteger;I)[B
    ...
    invoke-static {p0}, Lorg/bouncycastle/util/BigIntegers;->a(Ljava/math/BigInteger;)[B
...
.method private static hashPaddedPair(Lorg/bouncycastle/crypto/Digest;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-interface {p0, p2, v1, v0}, Lorg/bouncycastle/crypto/Digest;->update([BII)V

    array-length p2, p3

    invoke-interface {p0, p3, v1, p2}, Lorg/bouncycastle/crypto/Digest;->update([BII)V
    ...
    invoke-direct {p0, p3, p2}, Ljava/math/BigInteger;-><init>(I[B)V
...
.method public static validatePublicValue(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    sget-object p1, Lorg/bouncycastle/crypto/agreement/srp/SRP6Util;->a:Ljava/math/BigInteger;
