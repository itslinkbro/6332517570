...
.field private b:Lorg/bouncycastle/crypto/paddings/PaddedBufferedBlockCipher;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lorg/bouncycastle/crypto/examples/DESExample;->a:Z

    const/4 v0, 0x0

    iput-object v0, p0, Lorg/bouncycastle/crypto/examples/DESExample;->b:Lorg/bouncycastle/crypto/paddings/PaddedBufferedBlockCipher;

    iput-object v0, p0, Lorg/bouncycastle/crypto/examples/DESExample;->c:Ljava/io/BufferedInputStream;

    iput-object v0, p0, Lorg/bouncycastle/crypto/examples/DESExample;->d:Ljava/io/BufferedOutputStream;

    iput-object v0, p0, Lorg/bouncycastle/crypto/examples/DESExample;->e:[B
...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    iput-object v1, p0, Lorg/bouncycastle/crypto/examples/DESExample;->b:Lorg/bouncycastle/crypto/paddings/PaddedBufferedBlockCipher;

    iput-object v1, p0, Lorg/bouncycastle/crypto/examples/DESExample;->c:Ljava/io/BufferedInputStream;

    iput-object v1, p0, Lorg/bouncycastle/crypto/examples/DESExample;->d:Ljava/io/BufferedOutputStream;

    iput-object v1, p0, Lorg/bouncycastle/crypto/examples/DESExample;->e:[B

    iput-boolean p4, p0, Lorg/bouncycastle/crypto/examples/DESExample;->a:Z
    ...
    iput-object v2, p0, Lorg/bouncycastle/crypto/examples/DESExample;->c:Ljava/io/BufferedInputStream;
    :try_end_0
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/examples/DESExample;->d:Ljava/io/BufferedOutputStream;
    :try_end_1
    ...
    iput-object p2, p0, Lorg/bouncycastle/crypto/examples/DESExample;->e:[B
    ...
    iget-object p4, p0, Lorg/bouncycastle/crypto/examples/DESExample;->e:[B

    invoke-static {p4}, Lorg/bouncycastle/util/encoders/Hex;->a([B)[B
    ...
    invoke-static {v1}, Lorg/bouncycastle/util/encoders/Hex;->b([B)[B

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/crypto/examples/DESExample;->e:[B
    :try_end_5
...
.method public static main([Ljava/lang/String;)V
    ...
    :cond_1
    new-instance p0, Lorg/bouncycastle/crypto/examples/DESExample;

    invoke-direct {p0, v4, v5, v0, v2}, Lorg/bouncycastle/crypto/examples/DESExample;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)V

    invoke-direct {p0}, Lorg/bouncycastle/crypto/examples/DESExample;->process()V
...
.method private performDecrypt([B)V
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/examples/DESExample;->b:Lorg/bouncycastle/crypto/paddings/PaddedBufferedBlockCipher;
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/examples/DESExample;->c:Ljava/io/BufferedInputStream;
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/examples/DESExample;->b:Lorg/bouncycastle/crypto/paddings/PaddedBufferedBlockCipher;
    ...
    iget-object v3, p0, Lorg/bouncycastle/crypto/examples/DESExample;->b:Lorg/bouncycastle/crypto/paddings/PaddedBufferedBlockCipher;
    ...
    iget-object v3, p0, Lorg/bouncycastle/crypto/examples/DESExample;->d:Ljava/io/BufferedOutputStream;
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/examples/DESExample;->d:Ljava/io/BufferedOutputStream;
...
.method private performEncrypt([B)V
    ...
    iget-object p1, p0, Lorg/bouncycastle/crypto/examples/DESExample;->b:Lorg/bouncycastle/crypto/paddings/PaddedBufferedBlockCipher;
    ...
    :goto_0
    :try_start_0
    iget-object v1, p0, Lorg/bouncycastle/crypto/examples/DESExample;->c:Ljava/io/BufferedInputStream;
    ...
    invoke-static {p1, v8, v1}, Lorg/bouncycastle/util/encoders/Hex;->a([BII)[B
    ...
    iget-object v1, p0, Lorg/bouncycastle/crypto/examples/DESExample;->d:Ljava/io/BufferedOutputStream;
    ...
    invoke-static {p1, v8, v0}, Lorg/bouncycastle/util/encoders/Hex;->a([BII)[B

    move-result-object p1

    iget-object v0, p0, Lorg/bouncycastle/crypto/examples/DESExample;->d:Ljava/io/BufferedOutputStream;

    array-length v1, p1

    invoke-virtual {v0, p1, v8, v1}, Ljava/io/BufferedOutputStream;->write([BII)V

    iget-object p1, p0, Lorg/bouncycastle/crypto/examples/DESExample;->d:Ljava/io/BufferedOutputStream;
...
.method private process()V
    ...
    iget-boolean v0, p0, Lorg/bouncycastle/crypto/examples/DESExample;->a:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lorg/bouncycastle/crypto/examples/DESExample;->e:[B
    ...
    :goto_0
    :try_start_0
    iget-object v0, p0, Lorg/bouncycastle/crypto/examples/DESExample;->c:Ljava/io/BufferedInputStream;
