...
.method public constructor <init>(Lorg/bouncycastle/crypto/Digest;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/prng/DigestRandomGenerator;->d:Lorg/bouncycastle/crypto/Digest;
    ...
    iput-object v0, p0, Lorg/bouncycastle/crypto/prng/DigestRandomGenerator;->f:[B

    const-wide/16 v0, 0x1

    iput-wide v0, p0, Lorg/bouncycastle/crypto/prng/DigestRandomGenerator;->c:J
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/prng/DigestRandomGenerator;->e:[B
...
.method private cycleSeed()V
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/prng/DigestRandomGenerator;->f:[B

    invoke-direct {p0, v0}, Lorg/bouncycastle/crypto/prng/DigestRandomGenerator;->digestUpdate([B)V

    iget-wide v0, p0, Lorg/bouncycastle/crypto/prng/DigestRandomGenerator;->c:J

    const-wide/16 v2, 0x1

    add-long v4, v0, v2

    iput-wide v4, p0, Lorg/bouncycastle/crypto/prng/DigestRandomGenerator;->c:J
...
.method private digestAddCounter(J)V
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/prng/DigestRandomGenerator;->d:Lorg/bouncycastle/crypto/Digest;
...
.method private digestDoFinal([B)V
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/prng/DigestRandomGenerator;->d:Lorg/bouncycastle/crypto/Digest;
...
.method private generateState()V
    ...
    iput-wide v4, p0, Lorg/bouncycastle/crypto/prng/DigestRandomGenerator;->b:J
    ...
    sget-wide v2, Lorg/bouncycastle/crypto/prng/DigestRandomGenerator;->a:J
...
.method public addSeedMaterial(J)V
    ...
    iget-object p1, p0, Lorg/bouncycastle/crypto/prng/DigestRandomGenerator;->f:[B
...
.method public nextBytes([BII)V
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/prng/DigestRandomGenerator;->e:[B
