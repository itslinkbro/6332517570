...
.field private c:Ljavax/security/auth/x500/X500Principal;
...
.method public constructor <init>(Lorg/bouncycastle/asn1/x509/TBSCertList$CRLEntry;ZLjavax/security/auth/x500/X500Principal;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jce/provider/X509CRLEntryObject;->a:Lorg/bouncycastle/asn1/x509/TBSCertList$CRLEntry;

    iput-boolean p2, p0, Lorg/bouncycastle/jce/provider/X509CRLEntryObject;->b:Z

    iput-object p3, p0, Lorg/bouncycastle/jce/provider/X509CRLEntryObject;->c:Ljavax/security/auth/x500/X500Principal;

    invoke-direct {p0}, Lorg/bouncycastle/jce/provider/X509CRLEntryObject;->a()Ljavax/security/auth/x500/X500Principal;

    move-result-object p1

    iput-object p1, p0, Lorg/bouncycastle/jce/provider/X509CRLEntryObject;->d:Ljavax/security/auth/x500/X500Principal;
...
.method private a(Z)Ljava/util/Set;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jce/provider/X509CRLEntryObject;->a:Lorg/bouncycastle/asn1/x509/TBSCertList$CRLEntry;

    invoke-virtual {v0}, Lorg/bouncycastle/asn1/x509/TBSCertList$CRLEntry;->c()Lorg/bouncycastle/asn1/x509/X509Extensions;
...
.method private a()Ljavax/security/auth/x500/X500Principal;
    .locals 5

    iget-boolean v0, p0, Lorg/bouncycastle/jce/provider/X509CRLEntryObject;->b:Z
    ...
    iget-object v0, p0, Lorg/bouncycastle/jce/provider/X509CRLEntryObject;->c:Ljavax/security/auth/x500/X500Principal;
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/asn1/x509/GeneralName;->b()Lorg/bouncycastle/asn1/DEREncodable;
...
.method public getCertificateIssuer()Ljavax/security/auth/x500/X500Principal;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jce/provider/X509CRLEntryObject;->d:Ljavax/security/auth/x500/X500Principal;
...
.method public getCriticalExtensionOIDs()Ljava/util/Set;
    ...
    invoke-direct {p0, v0}, Lorg/bouncycastle/jce/provider/X509CRLEntryObject;->a(Z)Ljava/util/Set;
...
.method public getRevocationDate()Ljava/util/Date;
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/asn1/x509/TBSCertList$CRLEntry;->b()Lorg/bouncycastle/asn1/x509/Time;
...
.method public getSerialNumber()Ljava/math/BigInteger;
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/asn1/x509/TBSCertList$CRLEntry;->a()Lorg/bouncycastle/asn1/DERInteger;
...
.method public hashCode()I
    ...
    iget-boolean v0, p0, Lorg/bouncycastle/jce/provider/X509CRLEntryObject;->f:Z
    ...
    iput v0, p0, Lorg/bouncycastle/jce/provider/X509CRLEntryObject;->e:I

    const/4 v0, 0x1

    iput-boolean v0, p0, Lorg/bouncycastle/jce/provider/X509CRLEntryObject;->f:Z

    :cond_0
    iget v0, p0, Lorg/bouncycastle/jce/provider/X509CRLEntryObject;->e:I
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lorg/bouncycastle/jce/provider/X509CRLEntryObject;->a:Lorg/bouncycastle/asn1/x509/TBSCertList$CRLEntry;

    invoke-virtual {v2}, Lorg/bouncycastle/asn1/x509/TBSCertList$CRLEntry;->c()Lorg/bouncycastle/asn1/x509/X509Extensions;
    ...
    :try_start_0
    sget-object v5, Lorg/bouncycastle/asn1/x509/X509Extensions;->i:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    new-instance v5, Lorg/bouncycastle/asn1/x509/CRLReason;

    invoke-virtual {v7}, Lorg/bouncycastle/asn1/ASN1InputStream;->a()Lorg/bouncycastle/asn1/DERObject;

    move-result-object v6

    invoke-static {v6}, Lorg/bouncycastle/asn1/DEREnumerated;->a(Ljava/lang/Object;)Lorg/bouncycastle/asn1/DEREnumerated;

    move-result-object v6

    invoke-direct {v5, v6}, Lorg/bouncycastle/asn1/x509/CRLReason;-><init>(Lorg/bouncycastle/asn1/DEREnumerated;)V
    ...
    :cond_1
    sget-object v5, Lorg/bouncycastle/asn1/x509/X509Extensions;->n:Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    invoke-direct {v5, v6}, Lorg/bouncycastle/asn1/x509/GeneralNames;-><init>(Lorg/bouncycastle/asn1/ASN1Sequence;)V
