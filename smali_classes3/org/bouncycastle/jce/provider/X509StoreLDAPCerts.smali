...
.method private a(Lorg/bouncycastle/x509/X509CertStoreSelector;)Ljava/util/Collection;
    .locals 5
    ...
    invoke-virtual {v1, p1}, Lorg/bouncycastle/x509/X509CertPairStoreSelector;->a(Lorg/bouncycastle/x509/X509CertStoreSelector;)V
    ...
    invoke-virtual {v1, p1}, Lorg/bouncycastle/x509/X509CertPairStoreSelector;->b(Lorg/bouncycastle/x509/X509CertStoreSelector;)V

    new-instance p1, Ljava/util/HashSet;

    iget-object v2, p0, Lorg/bouncycastle/jce/provider/X509StoreLDAPCerts;->a:Lorg/bouncycastle/x509/util/LDAPStoreHelper;

    invoke-virtual {v2, v1}, Lorg/bouncycastle/x509/util/LDAPStoreHelper;->a(Lorg/bouncycastle/x509/X509CertPairStoreSelector;)Ljava/util/Collection;
    ...
    invoke-virtual {v3}, Lorg/bouncycastle/x509/X509CertificatePair;->a()Ljava/security/cert/X509Certificate;
    ...
    :cond_1
    invoke-virtual {v3}, Lorg/bouncycastle/x509/X509CertificatePair;->b()Ljava/security/cert/X509Certificate;
...
.method public final a(Lorg/bouncycastle/util/Selector;)Ljava/util/Collection;
    ...
    invoke-virtual {v1, p1}, Lorg/bouncycastle/x509/util/LDAPStoreHelper;->b(Lorg/bouncycastle/x509/X509CertStoreSelector;)Ljava/util/Collection;

    move-result-object v1

    invoke-interface {v0, v1}, Ljava/util/Set;->addAll(Ljava/util/Collection;)Z

    invoke-direct {p0, p1}, Lorg/bouncycastle/jce/provider/X509StoreLDAPCerts;->a(Lorg/bouncycastle/x509/X509CertStoreSelector;)Ljava/util/Collection;
    ...
    invoke-virtual {v1, p1}, Lorg/bouncycastle/x509/util/LDAPStoreHelper;->a(Lorg/bouncycastle/x509/X509CertStoreSelector;)Ljava/util/Collection;
