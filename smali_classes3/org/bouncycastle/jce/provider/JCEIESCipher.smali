...
.method protected engineDoFinal([BII[BI)I
    ...
    :cond_0
    :try_start_0
    iget-object p1, p0, Lorg/bouncycastle/jce/provider/JCEIESCipher;->g:Ljava/io/ByteArrayOutputStream;

    invoke-virtual {p1}, Ljava/io/ByteArrayOutputStream;->toByteArray()[B

    move-result-object p1

    iget-object p2, p0, Lorg/bouncycastle/jce/provider/JCEIESCipher;->g:Ljava/io/ByteArrayOutputStream;

    invoke-virtual {p2}, Ljava/io/ByteArrayOutputStream;->reset()V

    iget-object p2, p0, Lorg/bouncycastle/jce/provider/JCEIESCipher;->e:Lorg/bouncycastle/crypto/engines/IESEngine;
...
.method protected engineGetKeySize(Ljava/security/Key;)I
    ...
    invoke-interface {p1}, Lorg/bouncycastle/jce/interfaces/ECPrivateKey;->b()Ljava/math/BigInteger;
...
.method protected engineInit(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    invoke-static {p4}, Lorg/bouncycastle/jce/provider/asymmetric/ec/ECUtil;->a(Ljava/security/PublicKey;)Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;
    ...
    invoke-static {p2}, Lorg/bouncycastle/jce/provider/asymmetric/ec/ECUtil;->a(Ljava/security/PrivateKey;)Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;
    ...
    invoke-static {p4}, Lorg/bouncycastle/jce/provider/DHUtil;->a(Ljava/security/PublicKey;)Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;
    ...
    invoke-static {p2}, Lorg/bouncycastle/jce/provider/DHUtil;->a(Ljava/security/PrivateKey;)Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;
    ...
    iput-object p3, p0, Lorg/bouncycastle/jce/provider/JCEIESCipher;->i:Lorg/bouncycastle/jce/spec/IESParameterSpec;
    ...
    iget-object v2, p0, Lorg/bouncycastle/jce/provider/JCEIESCipher;->i:Lorg/bouncycastle/jce/spec/IESParameterSpec;

    invoke-virtual {v2}, Lorg/bouncycastle/jce/spec/IESParameterSpec;->b()[B

    move-result-object v2

    iget-object v3, p0, Lorg/bouncycastle/jce/provider/JCEIESCipher;->i:Lorg/bouncycastle/jce/spec/IESParameterSpec;

    invoke-virtual {v3}, Lorg/bouncycastle/jce/spec/IESParameterSpec;->c()I
    ...
    :pswitch_0
    iget-object p1, p0, Lorg/bouncycastle/jce/provider/JCEIESCipher;->e:Lorg/bouncycastle/crypto/engines/IESEngine;
...
.method protected engineUpdate([BII[BI)I
    ...
    iget-object p4, p0, Lorg/bouncycastle/jce/provider/JCEIESCipher;->g:Ljava/io/ByteArrayOutputStream;
