...
# instance fields
.field private e:Lorg/bouncycastle/crypto/BufferedAsymmetricBlockCipher;
...
.method public constructor <init>(Lorg/bouncycastle/crypto/AsymmetricBlockCipher;)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jce/provider/JCEElGamalCipher;->e:Lorg/bouncycastle/crypto/BufferedAsymmetricBlockCipher;
...
.method private a(Ljavax/crypto/spec/OAEPParameterSpec;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jce/provider/JCEElGamalCipher;->f:Ljava/security/spec/AlgorithmParameterSpec;
...
.method protected engineDoFinal([BII[BI)I
    ...
    iget-object v0, p0, Lorg/bouncycastle/jce/provider/JCEElGamalCipher;->e:Lorg/bouncycastle/crypto/BufferedAsymmetricBlockCipher;

    invoke-virtual {v0, p1, p2, p3}, Lorg/bouncycastle/crypto/BufferedAsymmetricBlockCipher;->processBytes([BII)V

    :try_start_0
    iget-object p1, p0, Lorg/bouncycastle/jce/provider/JCEElGamalCipher;->e:Lorg/bouncycastle/crypto/BufferedAsymmetricBlockCipher;
...
.method protected engineGetKeySize(Ljava/security/Key;)I
    ...
    invoke-interface {p1}, Lorg/bouncycastle/jce/interfaces/ElGamalKey;->a()Lorg/bouncycastle/jce/spec/ElGamalParameterSpec;
...
.method protected engineGetParameters()Ljava/security/AlgorithmParameters;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jce/provider/JCEElGamalCipher;->g:Ljava/security/AlgorithmParameters;

    if-nez v0, :cond_0

    iget-object v0, p0, Lorg/bouncycastle/jce/provider/JCEElGamalCipher;->f:Ljava/security/spec/AlgorithmParameterSpec;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jce/provider/JCEElGamalCipher;->g:Ljava/security/AlgorithmParameters;

    iget-object v0, p0, Lorg/bouncycastle/jce/provider/JCEElGamalCipher;->g:Ljava/security/AlgorithmParameters;

    iget-object v1, p0, Lorg/bouncycastle/jce/provider/JCEElGamalCipher;->f:Ljava/security/spec/AlgorithmParameterSpec;
...
.method protected engineInit(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    invoke-static {p2}, Lorg/bouncycastle/jce/provider/ElGamalUtil;->a(Ljava/security/PublicKey;)Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;
    ...
    invoke-static {p2}, Lorg/bouncycastle/jce/provider/ElGamalUtil;->a(Ljava/security/PrivateKey;)Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;
...
.method protected engineSetPadding(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jce/provider/JCEElGamalCipher;->e:Lorg/bouncycastle/crypto/BufferedAsymmetricBlockCipher;
    ...
    invoke-direct {p0, p1}, Lorg/bouncycastle/jce/provider/JCEElGamalCipher;->a(Ljavax/crypto/spec/OAEPParameterSpec;)V
...
.method protected engineUpdate([BII[BI)I
    ...
    iget-object p4, p0, Lorg/bouncycastle/jce/provider/JCEElGamalCipher;->e:Lorg/bouncycastle/crypto/BufferedAsymmetricBlockCipher;
