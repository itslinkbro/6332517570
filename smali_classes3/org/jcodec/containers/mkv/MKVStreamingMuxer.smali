...
.method private muxCues([Lorg/jcodec/movtool/streaming/VirtualTrack;)V
    ...
    iget-object v1, p0, Lorg/jcodec/containers/mkv/MKVStreamingMuxer;->mkvSeekHead:Lorg/jcodec/containers/mkv/boxes/EbmlMaster;

    invoke-virtual {v1}, Lorg/jcodec/containers/mkv/boxes/EbmlMaster;->size()J

    move-result-wide v1

    iget-object v3, p0, Lorg/jcodec/containers/mkv/MKVStreamingMuxer;->mkvInfo:Lorg/jcodec/containers/mkv/boxes/EbmlMaster;
    ...
    .line 204
    iget-object p1, p0, Lorg/jcodec/containers/mkv/MKVStreamingMuxer;->webmClusters:Ljava/util/LinkedList;
    ...
    .line 205
    iget-object v1, v1, Lorg/jcodec/containers/mkv/MKVStreamingMuxer$WebmCluster;->c:Lorg/jcodec/containers/mkv/boxes/EbmlMaster;

    invoke-static {v1}, Lorg/jcodec/containers/mkv/CuesFactory$CuePointMock;->make(Lorg/jcodec/containers/mkv/boxes/EbmlMaster;)Lorg/jcodec/containers/mkv/CuesFactory$CuePointMock;

    move-result-object v1

    invoke-virtual {v0, v1}, Lorg/jcodec/containers/mkv/CuesFactory;->add(Lorg/jcodec/containers/mkv/CuesFactory$CuePointMock;)V
    ...
    .line 208
    iget-object p1, p1, Lorg/jcodec/containers/mkv/boxes/EbmlMaster;->children:Ljava/util/ArrayList;
    ...
    invoke-virtual {v1, v0}, Lorg/jcodec/containers/mkv/boxes/EbmlMaster;->add(Lorg/jcodec/containers/mkv/boxes/EbmlBase;)V
...
.method private muxInfo([Lorg/jcodec/movtool/streaming/VirtualTrack;)Lorg/jcodec/containers/mkv/boxes/EbmlMaster;
    ...
    .line 132
    sget-object p1, Lorg/jcodec/containers/mkv/MKVType;->Info:Lorg/jcodec/containers/mkv/MKVType;
    ...
    .line 133
    sget-object v0, Lorg/jcodec/containers/mkv/MKVType;->TimecodeScale:Lorg/jcodec/containers/mkv/MKVType;

    const-wide/32 v1, 0xf4240

    invoke-static {p1, v0, v1, v2}, Lorg/jcodec/containers/mkv/muxer/MKVMuxer;->createChild(Lorg/jcodec/containers/mkv/boxes/EbmlMaster;Lorg/jcodec/containers/mkv/MKVType;J)V

    .line 134
    sget-object v0, Lorg/jcodec/containers/mkv/MKVType;->WritingApp:Lorg/jcodec/containers/mkv/MKVType;

    const-string v1, "JCodec v0.1.7"

    invoke-static {p1, v0, v1}, Lorg/jcodec/containers/mkv/muxer/MKVMuxer;->createChild(Lorg/jcodec/containers/mkv/boxes/EbmlMaster;Lorg/jcodec/containers/mkv/MKVType;Ljava/lang/String;)V

    .line 135
    sget-object v0, Lorg/jcodec/containers/mkv/MKVType;->MuxingApp:Lorg/jcodec/containers/mkv/MKVType;

    const-string v1, "JCodec MKVStreamingMuxer v0.1.7"
    ...
    .line 138
    sget-object v1, Lorg/jcodec/containers/mkv/MKVType;->Duration:Lorg/jcodec/containers/mkv/MKVType;

    iget-object v2, v0, Lorg/jcodec/containers/mkv/MKVStreamingMuxer$WebmCluster;->pkt:Lorg/jcodec/movtool/streaming/VirtualPacket;

    invoke-interface {v2}, Lorg/jcodec/movtool/streaming/VirtualPacket;->getPts()D

    move-result-wide v2

    iget-object v0, v0, Lorg/jcodec/containers/mkv/MKVStreamingMuxer$WebmCluster;->pkt:Lorg/jcodec/movtool/streaming/VirtualPacket;
    ...
    invoke-static {p1, v1, v2, v3}, Lorg/jcodec/containers/mkv/muxer/MKVMuxer;->createChild(Lorg/jcodec/containers/mkv/boxes/EbmlMaster;Lorg/jcodec/containers/mkv/MKVType;D)V

    .line 139
    sget-object v0, Lorg/jcodec/containers/mkv/MKVType;->DateUTC:Lorg/jcodec/containers/mkv/MKVType;

    new-instance v1, Ljava/util/Date;

    invoke-direct {v1}, Ljava/util/Date;-><init>()V

    invoke-static {p1, v0, v1}, Lorg/jcodec/containers/mkv/muxer/MKVMuxer;->createChild(Lorg/jcodec/containers/mkv/boxes/EbmlMaster;Lorg/jcodec/containers/mkv/MKVType;Ljava/util/Date;)V
...
.method private muxTracks([Lorg/jcodec/movtool/streaming/VirtualTrack;)Lorg/jcodec/containers/mkv/boxes/EbmlMaster;
    ...
    .line 154
    sget-object v2, Lorg/jcodec/containers/mkv/MKVType;->TrackType:Lorg/jcodec/containers/mkv/MKVType;

    const-wide/16 v5, 0x1

    invoke-static {v3, v2, v5, v6}, Lorg/jcodec/containers/mkv/muxer/MKVMuxer;->createChild(Lorg/jcodec/containers/mkv/boxes/EbmlMaster;Lorg/jcodec/containers/mkv/MKVType;J)V

    .line 155
    sget-object v2, Lorg/jcodec/containers/mkv/MKVType;->Name:Lorg/jcodec/containers/mkv/MKVType;
    ...
    invoke-static {v3, v2, v5}, Lorg/jcodec/containers/mkv/muxer/MKVMuxer;->createChild(Lorg/jcodec/containers/mkv/boxes/EbmlMaster;Lorg/jcodec/containers/mkv/MKVType;Ljava/lang/String;)V

    .line 156
    sget-object v2, Lorg/jcodec/containers/mkv/MKVType;->CodecID:Lorg/jcodec/containers/mkv/MKVType;
    ...
    .line 157
    sget-object v2, Lorg/jcodec/containers/mkv/MKVType;->CodecPrivate:Lorg/jcodec/containers/mkv/MKVType;

    invoke-virtual {v4}, Lorg/jcodec/movtool/streaming/CodecMeta;->getCodecPrivate()Ljava/nio/ByteBuffer;

    move-result-object v5

    invoke-static {v3, v2, v5}, Lorg/jcodec/containers/mkv/muxer/MKVMuxer;->createChild(Lorg/jcodec/containers/mkv/boxes/EbmlMaster;Lorg/jcodec/containers/mkv/MKVType;Ljava/nio/ByteBuffer;)V

    .line 159
    instance-of v2, v4, Lorg/jcodec/movtool/streaming/VideoCodecMeta;
    ...
    .line 161
    sget-object v2, Lorg/jcodec/containers/mkv/MKVType;->Video:Lorg/jcodec/containers/mkv/MKVType;
    ...
    invoke-static {v2, v5, v6, v7}, Lorg/jcodec/containers/mkv/muxer/MKVMuxer;->createChild(Lorg/jcodec/containers/mkv/boxes/EbmlMaster;Lorg/jcodec/containers/mkv/MKVType;J)V
    ...
    .line 166
    invoke-virtual {v3, v2}, Lorg/jcodec/containers/mkv/boxes/EbmlMaster;->add(Lorg/jcodec/containers/mkv/boxes/EbmlBase;)V
    ...
    .line 175
    instance-of v2, v4, Lorg/jcodec/movtool/streaming/AudioCodecMeta;
    ...
    .line 177
    sget-object v2, Lorg/jcodec/containers/mkv/MKVType;->Audio:Lorg/jcodec/containers/mkv/MKVType;
    ...
    invoke-virtual {v4}, Lorg/jcodec/movtool/streaming/AudioCodecMeta;->getChannelCount()I
    ...
    invoke-virtual {v4}, Lorg/jcodec/movtool/streaming/AudioCodecMeta;->getSampleSize()I
    ...
    invoke-virtual {v4}, Lorg/jcodec/movtool/streaming/AudioCodecMeta;->getSampleRate()I
...
.method public prepareHeader(Ljava/util/List;[Lorg/jcodec/movtool/streaming/VirtualTrack;)Lorg/jcodec/movtool/streaming/MovieSegment;
    ...
    .line 100
    iget-object p2, p0, Lorg/jcodec/containers/mkv/MKVStreamingMuxer;->segmentElem:Lorg/jcodec/containers/mkv/boxes/EbmlMaster;

    iget-object v0, p0, Lorg/jcodec/containers/mkv/MKVStreamingMuxer;->mkvSeekHead:Lorg/jcodec/containers/mkv/boxes/EbmlMaster;

    invoke-virtual {p2, v0}, Lorg/jcodec/containers/mkv/boxes/EbmlMaster;->add(Lorg/jcodec/containers/mkv/boxes/EbmlBase;)V

    .line 101
    iget-object p2, p0, Lorg/jcodec/containers/mkv/MKVStreamingMuxer;->segmentElem:Lorg/jcodec/containers/mkv/boxes/EbmlMaster;

    iget-object v0, p0, Lorg/jcodec/containers/mkv/MKVStreamingMuxer;->mkvInfo:Lorg/jcodec/containers/mkv/boxes/EbmlMaster;
    ...
    iget-object v0, p0, Lorg/jcodec/containers/mkv/MKVStreamingMuxer;->mkvTracks:Lorg/jcodec/containers/mkv/boxes/EbmlMaster;
    ...
    iget-object v0, p0, Lorg/jcodec/containers/mkv/MKVStreamingMuxer;->mkvCues:Lorg/jcodec/containers/mkv/boxes/EbmlMaster;

    invoke-virtual {p2, v0}, Lorg/jcodec/containers/mkv/boxes/EbmlMaster;->add(Lorg/jcodec/containers/mkv/boxes/EbmlBase;)V

    .line 105
    iget-object p2, p0, Lorg/jcodec/containers/mkv/MKVStreamingMuxer;->webmClusters:Ljava/util/LinkedList;
    ...
    .line 110
    iget-object p1, p0, Lorg/jcodec/containers/mkv/MKVStreamingMuxer;->segmentElem:Lorg/jcodec/containers/mkv/boxes/EbmlMaster;

    invoke-interface {p2, p1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 111
    new-instance p1, Lorg/jcodec/containers/mkv/MKVStreamingMuxer$HeaderSegment;

    invoke-direct {p1, p2}, Lorg/jcodec/containers/mkv/MKVStreamingMuxer$HeaderSegment;-><init>(Ljava/util/List;)V

    iput-object p1, p0, Lorg/jcodec/containers/mkv/MKVStreamingMuxer;->headerChunk:Lorg/jcodec/movtool/streaming/MovieSegment;

    .line 113
    iget-object p1, p0, Lorg/jcodec/containers/mkv/MKVStreamingMuxer;->headerChunk:Lorg/jcodec/movtool/streaming/MovieSegment;
...
.method public preparePacket(Lorg/jcodec/movtool/streaming/VirtualTrack;Lorg/jcodec/movtool/streaming/VirtualPacket;IIJ)Lorg/jcodec/movtool/streaming/MovieSegment;
    ...
    .line 83
    new-instance v8, Lorg/jcodec/containers/mkv/MKVStreamingMuxer$WebmCluster;
    ...
    iput-object p1, p0, Lorg/jcodec/containers/mkv/MKVStreamingMuxer;->webmClusters:Ljava/util/LinkedList;
