...
.method public static fromADTS(Lorg/jcodec/codecs/aac/ADTSParser$Header;)Lorg/jcodec/containers/mp4/boxes/Box;
    ...
    invoke-direct {v0, v2}, Lorg/jcodec/common/io/BitWriter;-><init>(Ljava/nio/ByteBuffer;)V
    ...
    invoke-direct/range {v1 .. v7}, Lorg/jcodec/codecs/mpeg4/mp4/EsdsBox;-><init>(Ljava/nio/ByteBuffer;IIIII)V
...
.method protected doWrite(Ljava/nio/ByteBuffer;)V
    ...
    .line 60
    new-instance v0, Lorg/jcodec/codecs/mpeg4/es/ES;

    iget v4, p0, Lorg/jcodec/codecs/mpeg4/mp4/EsdsBox;->trackId:I

    new-array v1, v1, [Lorg/jcodec/codecs/mpeg4/es/Descriptor;

    new-instance v11, Lorg/jcodec/codecs/mpeg4/es/DecoderConfig;

    iget v6, p0, Lorg/jcodec/codecs/mpeg4/mp4/EsdsBox;->objectType:I

    iget v7, p0, Lorg/jcodec/codecs/mpeg4/mp4/EsdsBox;->bufSize:I

    iget v8, p0, Lorg/jcodec/codecs/mpeg4/mp4/EsdsBox;->maxBitrate:I

    iget v9, p0, Lorg/jcodec/codecs/mpeg4/mp4/EsdsBox;->avgBitrate:I

    new-array v10, v2, [Lorg/jcodec/codecs/mpeg4/es/Descriptor;

    new-instance v5, Lorg/jcodec/codecs/mpeg4/es/DecoderSpecific;

    iget-object v12, p0, Lorg/jcodec/codecs/mpeg4/mp4/EsdsBox;->streamInfo:Ljava/nio/ByteBuffer;

    invoke-direct {v5, v12}, Lorg/jcodec/codecs/mpeg4/es/DecoderSpecific;-><init>(Ljava/nio/ByteBuffer;)V

    aput-object v5, v10, v3

    move-object v5, v11

    invoke-direct/range {v5 .. v10}, Lorg/jcodec/codecs/mpeg4/es/DecoderConfig;-><init>(IIII[Lorg/jcodec/codecs/mpeg4/es/Descriptor;)V

    aput-object v11, v1, v3

    new-instance v3, Lorg/jcodec/codecs/mpeg4/es/SL;

    invoke-direct {v3}, Lorg/jcodec/codecs/mpeg4/es/SL;-><init>()V

    aput-object v3, v1, v2

    invoke-direct {v0, v4, v1}, Lorg/jcodec/codecs/mpeg4/es/ES;-><init>(I[Lorg/jcodec/codecs/mpeg4/es/Descriptor;)V

    invoke-virtual {v0, p1}, Lorg/jcodec/codecs/mpeg4/es/ES;->write(Ljava/nio/ByteBuffer;)V
    ...
    new-array v10, v3, [Lorg/jcodec/codecs/mpeg4/es/Descriptor;
...
.method public parse(Ljava/nio/ByteBuffer;)V
    ...
    invoke-static {p1, v0, v1}, Lorg/jcodec/codecs/mpeg4/es/Descriptor;->find(Lorg/jcodec/codecs/mpeg4/es/Descriptor;Ljava/lang/Class;I)Ljava/lang/Object;
