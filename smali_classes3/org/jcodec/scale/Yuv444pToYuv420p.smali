...
.method public transform(Lorg/jcodec/common/model/Picture;Lorg/jcodec/common/model/Picture;)V
    ...
    invoke-direct {p0, v2, v3, v4, v5}, Lorg/jcodec/scale/Yuv444pToYuv420p;->copyAvg([I[III)V
    ...
    invoke-direct {p0, v3, v4, v5, p1}, Lorg/jcodec/scale/Yuv444pToYuv420p;->copyAvg([I[III)V

    .line 27
    iget p1, p0, Lorg/jcodec/scale/Yuv444pToYuv420p;->shiftUp:I

    iget v3, p0, Lorg/jcodec/scale/Yuv444pToYuv420p;->shiftDown:I
    ...
    invoke-direct {p0, p1, v1}, Lorg/jcodec/scale/Yuv444pToYuv420p;->up([II)V
    ...
    invoke-direct {p0, p1, v0}, Lorg/jcodec/scale/Yuv444pToYuv420p;->up([II)V
    ...
    iget p2, p0, Lorg/jcodec/scale/Yuv444pToYuv420p;->shiftUp:I

    iget v0, p0, Lorg/jcodec/scale/Yuv444pToYuv420p;->shiftDown:I

    sub-int/2addr p2, v0

    invoke-direct {p0, p1, p2}, Lorg/jcodec/scale/Yuv444pToYuv420p;->up([II)V

    return-void

    .line 31
    :cond_0
    iget p1, p0, Lorg/jcodec/scale/Yuv444pToYuv420p;->shiftDown:I

    iget v3, p0, Lorg/jcodec/scale/Yuv444pToYuv420p;->shiftUp:I
    ...
    invoke-direct {p0, p1, v1}, Lorg/jcodec/scale/Yuv444pToYuv420p;->down([II)V
    ...
    invoke-direct {p0, p1, v0}, Lorg/jcodec/scale/Yuv444pToYuv420p;->down([II)V
    ...
    iget p2, p0, Lorg/jcodec/scale/Yuv444pToYuv420p;->shiftDown:I

    iget v0, p0, Lorg/jcodec/scale/Yuv444pToYuv420p;->shiftUp:I

    sub-int/2addr p2, v0

    invoke-direct {p0, p1, p2}, Lorg/jcodec/scale/Yuv444pToYuv420p;->down([II)V
