...
.method public getByteBuffer(JJ)Ljava/nio/ByteBuffer;
    ...
    .line 221
    iget-object v5, v1, Lcom/googlecode/mp4parser/BasicContainer;->dataSource:Lcom/googlecode/mp4parser/DataSource;
    ...
    .line 223
    :try_start_0
    iget-object v6, v1, Lcom/googlecode/mp4parser/BasicContainer;->dataSource:Lcom/googlecode/mp4parser/DataSource;

    iget-wide v7, v1, Lcom/googlecode/mp4parser/BasicContainer;->startPosition:J

    const/4 v9, 0x0

    add-long v9, v7, p1

    invoke-interface {v6, v9, v10, v3, v4}, Lcom/googlecode/mp4parser/DataSource;->map(JJ)Ljava/nio/ByteBuffer;
    ...
    .line 230
    iget-object v8, v1, Lcom/googlecode/mp4parser/BasicContainer;->boxes:Ljava/util/List;
    ...
    .line 232
    invoke-interface {v9}, Lcom/coremedia/iso/boxes/Box;->getSize()J
    ...
    .line 236
    invoke-interface {v9, v11}, Lcom/coremedia/iso/boxes/Box;->getBox(Ljava/nio/channels/WritableByteChannel;)V
