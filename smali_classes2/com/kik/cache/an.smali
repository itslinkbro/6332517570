.class public final Lcom/kik/cache/an;
...
.method public constructor <init>(Lrx/d;Lcom/kik/cache/KikVolleyImageLoader;Landroid/content/res/Resources;)V
    ...
    .line 29
    iput-object p1, p0, Lcom/kik/cache/an;->a:Lrx/d;

    .line 30
    iput-object p2, p0, Lcom/kik/cache/an;->b:Lcom/kik/cache/KikVolleyImageLoader;

    .line 31
    iput-object p3, p0, Lcom/kik/cache/an;->c:Landroid/content/res/Resources;
...
.method private a(IILandroid/graphics/Bitmap;)Lrx/d;
    ...
    .line 43
    iget-object v0, p0, Lcom/kik/cache/an;->a:Lrx/d;

    invoke-static {p0, p1, p2, p3}, Lcom/kik/cache/ao;->a(Lcom/kik/cache/an;IILandroid/graphics/Bitmap;)Lrx/functions/g;
...
.method static synthetic a(Lcom/kik/cache/an;IILandroid/graphics/Bitmap;Lcom/kik/core/domain/users/a/c;)Lrx/d;
    .locals 7

    if-nez p4, :cond_0

    .line 45
    iget-object p0, p0, Lcom/kik/cache/an;->c:Landroid/content/res/Resources;
    ...
    .line 54
    invoke-static {p0, p4, p1, p2}, Lcom/kik/cache/ap;->a(Lcom/kik/cache/an;Lcom/kik/cache/UserByteImageRequest;II)Lrx/functions/b;
    ...
    new-instance p2, Lcom/kik/cache/an$1;

    invoke-direct {p2, p0, p3}, Lcom/kik/cache/an$1;-><init>(Lcom/kik/cache/an;Landroid/graphics/Bitmap;)V
    ...
    invoke-static {}, Lcom/kik/cache/aq;->a()Lrx/functions/g;
...
.method static synthetic a(Lcom/kik/cache/an;Lcom/kik/cache/UserByteImageRequest;IILrx/Emitter;)V
    .locals 6

    .line 57
    iget-object v0, p0, Lcom/kik/cache/an;->b:Lcom/kik/cache/KikVolleyImageLoader;

    new-instance v2, Lcom/kik/cache/an$2;

    invoke-direct {v2, p0, p4}, Lcom/kik/cache/an$2;-><init>(Lcom/kik/cache/an;Lrx/Emitter;)V
...
.method public final a(II)Lrx/d;
    ...
    .line 37
    iget-object v0, p0, Lcom/kik/cache/an;->c:Landroid/content/res/Resources;

    invoke-static {v0, p1, p2}, Lcom/kik/cache/d;->a(Landroid/content/res/Resources;II)Landroid/graphics/Bitmap;

    move-result-object v0

    invoke-direct {p0, p1, p2, v0}, Lcom/kik/cache/an;->a(IILandroid/graphics/Bitmap;)Lrx/d;
...
.method public final bridge synthetic a(IILjava/lang/Object;)Lrx/d;
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/kik/cache/an;->a(IILandroid/graphics/Bitmap;)Lrx/d;
