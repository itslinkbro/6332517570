...
.method static constructor <clinit>()V
    ...
    const-string v1, "ANIMALS_AND_PET_SUPPLIES"

    const-string v2, "Animals & Pet Supplies"

    const/4 v3, 0x0

    invoke-direct {v0, v1, v3, v2}, Lio/branch/referral/util/ProductCategory;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    const-string v1, "APPAREL_AND_ACCESSORIES"

    const-string v2, "Apparel & Accessories"

    const/4 v4, 0x1

    invoke-direct {v0, v1, v4, v2}, Lio/branch/referral/util/ProductCategory;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    const-string v1, "ARTS_AND_ENTERTAINMENT"

    const-string v2, "Arts & Entertainment"

    const/4 v5, 0x2

    invoke-direct {v0, v1, v5, v2}, Lio/branch/referral/util/ProductCategory;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    const-string v1, "BABY_AND_TODDLER"

    const-string v2, "Baby & Toddler"

    const/4 v6, 0x3

    invoke-direct {v0, v1, v6, v2}, Lio/branch/referral/util/ProductCategory;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    const-string v1, "BUSINESS_AND_INDUSTRIAL"

    const-string v2, "Business & Industrial"

    const/4 v7, 0x4

    invoke-direct {v0, v1, v7, v2}, Lio/branch/referral/util/ProductCategory;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    const-string v1, "CAMERAS_AND_OPTICS"

    const-string v2, "Cameras & Optics"

    const/4 v8, 0x5

    invoke-direct {v0, v1, v8, v2}, Lio/branch/referral/util/ProductCategory;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    invoke-direct {v0, v1, v9, v2}, Lio/branch/referral/util/ProductCategory;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    const-string v1, "FOOD_BEVERAGES_AND_TOBACCO"

    const-string v2, "Food, Beverages & Tobacco"

    const/4 v10, 0x7

    invoke-direct {v0, v1, v10, v2}, Lio/branch/referral/util/ProductCategory;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    invoke-direct {v0, v1, v11, v2}, Lio/branch/referral/util/ProductCategory;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    invoke-direct {v0, v1, v12, v2}, Lio/branch/referral/util/ProductCategory;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    const-string v1, "HEALTH_AND_BEAUTY"

    const-string v2, "Health & Beauty"

    const/16 v13, 0xa

    invoke-direct {v0, v1, v13, v2}, Lio/branch/referral/util/ProductCategory;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    invoke-direct {v0, v1, v14, v2}, Lio/branch/referral/util/ProductCategory;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    const-string v1, "LUGGAGE_AND_BAGS"

    const-string v2, "Luggage & Bags"

    const/16 v15, 0xc

    invoke-direct {v0, v1, v15, v2}, Lio/branch/referral/util/ProductCategory;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    const-string v1, "OFFICE_SUPPLIES"
    ...
    const-string v1, "RELIGIOUS_AND_CEREMONIAL"
    ...
    const-string v1, "SPORTING_GOODS"
    ...
    const-string v1, "TOYS_AND_GAMES"
    ...
    const-string v1, "VEHICLES_AND_PARTS"
    ...
    sget-object v1, Lio/branch/referral/util/ProductCategory;->ANIMALS_AND_PET_SUPPLIES:Lio/branch/referral/util/ProductCategory;
